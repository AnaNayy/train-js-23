...
class ContentContainer {
  ...
  // Створюємо removeElement, який отримує element як параметр, знаходить його індекс у масиві
  // та видаляє, якщо елемент знайдено.
  elements = [];
...
class Article extends ContentContainer {
  // Створюємо конструктор класу, який приймає title назву статті як параметр та ініціалізує
  // об'єкт з нею
